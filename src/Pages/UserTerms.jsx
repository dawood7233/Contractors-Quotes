  ...
  return (
    <div className="user-terms pt-20 pb-10">
      <div className="bg-gradient-to-r from-amber-400 to-secondary text-black text-center py-16 px-6 w-full hover">
        <h1 className="text-4xl font-bold mb-4 cursor-pointer">User Terms And Conditions</h1>
      </div>
      
      <section>
        <p>
          <strong>THIS AGREEMENT CONTAINS A MANDATORY ARBITRATION PROVISION, WAIVER OF JURY TRIAL & CLASS ACTION.</strong> PLEASE REVIEW ALL PROVISIONS CONTAINED HEREIN. If you do not agree to these provisions, do not use this platform/site or services. By accessing, browsing or using this platform/site and its services, through any direct or indirect means, or by using the goods or services provided and offered in or through this platform, by any alternative methods (including, for example, telephone, mail, text, email, or facsimile), you accept and agree to be bound by this Agreement, these Services, and our Privacy Policy, which is incorporated by reference.
        </p>
        <p>
          GetAContractorNow.com, a Pennsylvania limited liability company and its affiliates and subsidiaries, (collectively “GetAContractorNow.com”, “we”, “us”, “our”, or “Company”) encourages all users of this platform and service to review this Terms of Use Agreement (“Agreement”).
        </p>
      </section>
      ...
      <section>
        <p>
          You shall not use this platform/service for any illegal purpose or for the transmission of any unlawful material or material that is abusive, harmful, harassing, libelous, racially or ethnically offensive, invasive of another's privacy, obscene, threatening, vulgar, sexually explicit, tortious, defamatory, or that infringes or may infringe on the intellectual property or rights of another, or in a reasonable person’s view objectionable. Other prohibited activities include but are not limited to:
        </p>
        <ul>
          <li>Interfering with the proper working of this platform system, site, or service.</li>
          <li>Using any robot, spider, or other automated devices to monitor or copy our web pages or content without prior written permission.</li>
          <li>Uploading, posting, transmitting, or making available data or content you do not have the right to distribute.</li>
      ...
      <section>
        <p>
          Our platform/services contain intellectual property owned by us and other parties. Except as otherwise specifically provided in this Agreement, you may not download or save a copy of the platform/services content for any purpose other than personal, non-commercial use.
        </p>
      </section>
      ...
      <section>
        <p>
          IN NO EVENT WILL WE OR OUR AFFILIATES BE LIABLE TO ANY PARTY FOR ANY INDIRECT, DIRECT, SPECIAL, PUNITIVE, INCIDENTAL, OR CONSEQUENTIAL DAMAGES ARISING IN ANY WAY OUT OF THE USE OR INABILITY TO USE THE PLATFORM/SERVICES.
        </p>
      </section>
      ...
      <section>
        <p>
          All disputes or claims arising between you and us shall be resolved exclusively through final and binding arbitration. You agree to waive your right to participate in any class action lawsuit or class-wide arbitration.
        </p>
      </section>
      ...
      <section>
        <p>
          You agree to indemnify and hold GetAContractorNow.com and its affiliates harmless from any claim or demand arising out of your use of this platform or violation of this Agreement.
        </p>
      </section>
      ...
      <section>
        <p>
          We may terminate or suspend this platform/service at any time for any reason without notice to you.
        </p>
      </section>
      ...
      <section>
        <p>
          This Agreement constitutes the entire terms of use agreement between you and us, superseding any prior agreements.
        </p>
      </section>
    </div>
  );
